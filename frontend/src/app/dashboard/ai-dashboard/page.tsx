...
const QUICK_ACTIONS = [
  ...
  { label: 'Market Research', href: '/dashboard/intelligence?tab=market', icon: '📈', color: 'bg-indigo-500/10 border-indigo-500/20 text-indigo-300 hover:border-indigo-500/40 hover:shadow-[0_0_20px_rgba(99,102,241,0.15)]' },
  { label: 'Competitor Intel', href: '/dashboard/intelligence?tab=competitors', icon: '🛡️', color: 'bg-violet-500/10 border-violet-500/20 text-violet-300 hover:border-violet-500/40 hover:shadow-[0_0_20px_rgba(139,92,246,0.15)]' },
  { label: 'Cost Estimation', href: '/dashboard/intelligence?tab=costs', icon: '💵', color: 'bg-emerald-500/10 border-emerald-500/20 text-emerald-300 hover:border-emerald-500/40 hover:shadow-[0_0_20px_rgba(16,185,129,0.15)]' },
  { label: 'Risk Analysis', href: '/dashboard/intelligence?tab=risks', icon: '⚠️', color: 'bg-amber-500/10 border-amber-500/20 text-amber-300 hover:border-amber-500/40 hover:shadow-[0_0_20px_rgba(245,158,11,0.15)]' },
